...
const SHOTS = [
  ...
  { src: '/eder/img/ig-07.jpg', alt: 'Eder chegando a Noronha', h: 'tall', cap: 'Chegada' },
  ...
  { src: '/eder/img/ig-09.jpg', alt: 'Eder de pé sobre a pista lotada', h: 'short', cap: 'Pista' },
  { src: '/eder/img/stage-white.jpg', alt: 'Eder de branco no palco com microfone', h: 'tall', cap: 'Palco' },
